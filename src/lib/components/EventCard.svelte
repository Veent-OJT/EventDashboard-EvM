<script lang="ts">
    ...
    export let setIsModalOpen: (value: boolean) => void;
  ...
  <div class="relative rounded-lg p-6">
    <div class="flex justify-end md:justify-end absolute top-auto right-4 md:right-16 lg:right-36">
      <button on:click={() => setIsModalOpen(true)} class="flex items-center space-x-2 cursor-pointer hover:opacity-80 transition-opacity duration-200 px-4 py-2">
      ...
      <div class="fixed inset-0 backdrop-blur-md flex items-center justify-center p-4 overflow-auto">
        <div class="bg-white border rounded-lg w-full max-w-4xl min-h-[50vh] max-h-[70vh] flex flex-col overflow-auto">
          ...
          <div class="flex justify-end gap-3 p-4">
            <button on:click={() => setIsModalOpen(false)} class="px-4 py-2 text-gray-600 hover:text-gray-800 border-gray-200 border-1 rounded">
              Cancel
            </button>
